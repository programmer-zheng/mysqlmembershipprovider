...
//// https://aspnetwebstack.codeplex.com/SourceControl/latest#src/WebMatrix.WebData/WebSecurity.cs
/**********************************************************************************************************************/
	...
	public static class MySqlWebSecurity
	{
		...
		internal static void PreAppStartInit()
		{
			...
			if (ConfigUtil.MySqlSimpleMembershipEnabled)
			{
				...
				var builtInRoles = System.Web.Security.Roles.Providers[BuiltInRolesProviderName];
		...
		{
            Debug.WriteLine("MySqlWebSecurity.InitializeProviders called.");
		...
		{
            Debug.WriteLine("MySqlWebSecurity.InitializeMembershipProvider called.");
		...
		{
            Debug.WriteLine("MySqlWebSecurity.InitializeRoleProvider called.");
        ...
        public static bool LoginLocal(string userName, string password, bool persistCookie = false)
        {
            var provider = VerifyProvider();
		...
		public static bool ChangePassword(string userName, string currentPassword, string newPassword)
		{
			...
			{
                Trace.TraceWarning("When chaning password for user {0}, {1}", userName, e.Message);
			}
