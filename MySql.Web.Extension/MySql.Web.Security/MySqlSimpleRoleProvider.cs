...
namespace MySql.Web.Security
{
	...
	public class MySqlSimpleRoleProvider : RoleProvider
	{
		...
		{
            Trace.TraceInformation("At service startup, MySqlImpleRoleProvider created.");
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="MySqlSimpleRoleProvider"/> class.
        /// Used by WebSecurity of MVC.
		/// </summary>
		...
		public MySqlSimpleRoleProvider(RoleProvider previousProvider)
		{
            ...
            Trace.TraceInformation("At service startup, MySqlImpleRoleProvider created with previousProvider.");
